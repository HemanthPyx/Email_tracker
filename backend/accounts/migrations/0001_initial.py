    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('personal', 'Personal'), ('work', 'Work'), ('gaming', 'Gaming'), ('shopping', 'Shopping'), ('social', 'Social Media'), ('finance', 'Finance'), ('education', 'Education'), ('other', 'Other')], default='personal', max_length=50)),
